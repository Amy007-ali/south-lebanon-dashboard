            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="number"
                           ...
                           value="{{ old('damaged_buildings', $village->damaged_buildings) }}"
                           min="0"
                           class="w-full border rounded-lg px-3 py-2">
                </div>
                ...
                <div>
                    ...
                    <input type="number"
                           ...
                           value="{{ old('displaced_families', $village->displaced_families) }}"
                           min="0"
                           class="w-full border rounded-lg px-3 py-2">
                </div>
                ...
                <div>
                    ...
                    <select name="accessible"
                        ...
                        <option value="1"
                            {{ old('accessible', $village->accessible) == 1 ? 'selected' : '' }}>
                            Accessible
                        </option>

                        <option value="0"
                            {{ old('accessible', $village->accessible) == 0 ? 'selected' : '' }}>
                            Inaccessible
                        </option>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text"
                           ...
                           value="{{ old(
                               'emergency_contact',
                               $village->emergencyProfile?->emergency_contact
                           ) }}"
                           class="w-full border rounded-lg px-3 py-2">
                </div>
                ...
                <div>
                    ...
                    <textarea name="emergency_notes"
                              ...
                              class="w-full border rounded-lg px-3 py-2">{{ old(
                                  'emergency_notes',
                                  $village->emergencyProfile?->notes
                              ) }}</textarea>
                </div>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text"
                           ...
                           value="{{ old(
                               'organization_name',
                               $village->aidOrganizations->first()?->name
                           ) }}"
                           class="w-full border rounded-lg px-3 py-2">
                </div>
                ...
                <div>
                    ...
                    <input type="text"
                           ...
                           value="{{ old(
                               'organization_type',
                               $village->aidOrganizations->first()?->type
                           ) }}"
                           class="w-full border rounded-lg px-3 py-2">
                </div>
